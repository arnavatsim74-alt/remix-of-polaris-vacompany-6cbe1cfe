              ...
              {notams.map((notam) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <ConfirmDialog trigger={<Button size="icon" variant="ghost" className="h-8 w-8 text-destructive hover:text-destructive hover:bg-destructive/10"><Trash2 className="h-4 w-4" /></Button>} title="Delete NOTAM?" description="This NOTAM will be permanently deleted." onConfirm={() => deleteNotamMutation.mutate(notam.id)} />
                  </div>
                </div>
              ))}
            </div>
